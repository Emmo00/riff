...
export function TagInput({
  ...
  useEffect(() => {
    if (inputValue.trim()) {
      ...
      const popular = suggestions.filter((suggestion) => !tags.includes(suggestion.toLowerCase())).slice(0, 12)
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        {showSuggestions && filteredSuggestions.length > 0 && (
          <div className="absolute top-full left-0 right-0 mt-1 bg-[#2a2a2a] border border-gray-600 rounded-lg shadow-lg z-10 max-h-48 overflow-y-auto">
            <div className="p-2">
              <p className="text-xs text-gray-400 mb-2 px-2">{inputValue ? "Matching tags:" : "Popular tags:"}</p>
      ...
      <div className="text-xs text-gray-500 space-y-1">
        ...
        <p>• Tags help listeners discover your music through search and recommendations</p>
